...
export default function SegurancaPatrimonial() {
  ...
  const topics = [
    ...
    },
    {
      ...
      description: "Os operadores de monitoramento do Grupo Souza Lima têm capacitação e treinamento constante para poder realizar monitoramento de veículos via satélite, sistemas de CFTV e alarmes de casas e veículos."
    },
  ]
